...
int main(int argc, char *argv[])
{
    ...
    char *path_v = "q.264";
    char *url_v = "rtp://172.29.14.98:10086?localrtpport=10000";
    ...
    re = avformat_alloc_output_context2(&pFormatCtxV_O, nullptr, "rtp", nullptr);
    if (re < 0)
    {
        printf("");
    }
    ...
    while (true)
    {
        ...
        {
            if(re==AVERROR_EOF) {
                int ret = avformat_seek_file(pFormatCtxV, -1, INT64_MIN, 0, INT64_MAX, AVSEEK_FLAG_BYTE);
